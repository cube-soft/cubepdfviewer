...
namespace PDFViewer
{
    ...
    public class ShadowDrawing
    {
        ...
        static Image shadowDownRight = new Bitmap(Cube.Properties.Resources.tshadowdownright);
        static Image shadowDownLeft = new Bitmap(Cube.Properties.Resources.tshadowdownleft);
        static Image shadowDown = new Bitmap(Cube.Properties.Resources.tshadowdown);
        static Image shadowRight = new Bitmap(Cube.Properties.Resources.tshadowright);
        static Image shadowTopRight = new Bitmap(Cube.Properties.Resources.tshadowtopright);
